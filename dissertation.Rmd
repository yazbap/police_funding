...
da38651.0001_filtered <- da38651.0001 %>%
  ...
  mutate(
    ...
    is_city = ifelse(AGENCYSAMPTYPE == "(4) County police", 0, 1),
    county_state = ifelse(AGENCYSAMPTYPE == "(4) County police", paste(County, STATE, sep= "_"), NA),
...
counties <- da38651.0001_filtered %>%
  filter(AGENCYSAMPTYPE == "(4) County police") %>%
