...
police_df <- da38651.0001 %>%
  ...
  mutate(
    ...
    City = case_when(
      ...
      AGENCYNAME == "rio arriba county sheriff's office" & STATE == "NM" ~ "española",
...
variable_names <- c(
  ...
  "perc_white" = "Percent White",
  "perc_hispanic" = "Percent Hispanic",
  "perc_less_hs" = "Percent Less Than HS",
  "perc_associates" = "Percent Associates",
  "perc_bachelors" = "Percent Bachelors",
  "perc_graduate_professional" = "Percent Graduate/Professional",
  "perc_not_in_labor_force" = "Percent Not in Labor Force",
...
# Print result_table in an academic format
kable(result_table, format = "markdown", caption = "Table 3: Peaceful Analysis Post Matching", 
      col.names = c("Variable", "Control Mean", "Treatment Mean", "Control Std Dev", "Treatment Std Dev"))
...
for (variable in variables) {
  ...
  mean_treatment <- mean(m_data_violent[[variable]][m_data_violent$violent_protest == 1], na.rm = TRUE)
  mean_control <- mean(m_data_violent[[variable]][m_data_violent$violent_protest == 0], na.rm = TRUE)
  sd_treatment <- sd(m_data_violent[[variable]][m_data_violent$violent_protest == 1], na.rm = TRUE)
  sd_control <- sd(m_data_violent[[variable]][m_data_violent$violent_protest == 0], na.rm = TRUE)
...
# Print result_table in an academic format
kable(result_table, format = "markdown", caption = "Table 4: Violent Analysis Post Matching", 
      col.names = c("Variable", "Control Mean", "Treatment Mean", "Control Std Dev", "Treatment Std Dev"))
